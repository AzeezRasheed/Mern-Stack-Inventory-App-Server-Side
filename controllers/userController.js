...
const loginUser = asyncHandler(async (req, res) => {
  ...
  // User exists, please check if password is correct
...
const forgotPassword = asyncHandler(async (req, res) => {
  ...
  //We first delete token if it exists before
  ...
  //we create a new reset url that would be sent to the user email address
  const resetUrl = `${process.env.FRONTEND_URL}/resetpassword/${resetToken}`;

  //the message that would be sent to the user email address
  const message = `
